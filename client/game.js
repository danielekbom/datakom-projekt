...
function drawMap(){
    ...
    for(y = Math.floor(player.y / tileSize - 11); y < Math.floor(player.y / tileSize + 11); y++){
        ...
        for(x = Math.floor(player.x / tileSize - 16); x < Math.floor(player.x / tileSize + 16); x++){
            ...
            if(map[y][x] == 12) ctx.drawImage(Img.ground1,416,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 13) ctx.drawImage(Img.ground1,448,292,32,32,tileX,tileY,tileSize,tileSize);
            ...
            if(map[y][x] == 19) ctx.drawImage(Img.ground1,416,320,32,32,tileX,tileY,tileSize,tileSize);
            ...
            if(map[y][x] == 22) ctx.drawImage(Img.ground1,384,288,32,32,tileX,tileY,tileSize,tileSize);
