...
function drawMap(){
    ...
    for(y = Math.floor(player.y / tileSize - 11); y < Math.floor(player.y / tileSize + 11); y++){
        ...
        for(x = Math.floor(player.x / tileSize - 16); x < Math.floor(player.x / tileSize + 16); x++){
            ...
            if(map[y][x] == 1) ctx.drawImage(Img.water1,0,448,16,32,tileX,tileY,tileSize,tileSize);
            ...
            if(map[y][x] == 7) ctx.drawImage(Img.ground1,224,128,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 8) ctx.drawImage(Img.ground1,288,192,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 9) ctx.drawImage(Img.ground1,192,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10) ctx.drawImage(Img.ground1,320,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 11) ctx.drawImage(Img.ground1,320,192,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10012) ctx.drawImage(Img.ground1,416,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10013) ctx.drawImage(Img.ground1,448,292,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 14) ctx.drawImage(Img.ground1,448,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 15) ctx.drawImage(Img.ground1,512,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 16) ctx.drawImage(Img.ground1,416,128,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10017) ctx.drawImage(Img.water1,32,320,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 18) ctx.drawImage(Img.ground1,416,192,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10019) ctx.drawImage(Img.ground1,416,320,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 20) ctx.drawImage(Img.ground1,512,192,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10021) ctx.drawImage(Img.water1,32,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10022) ctx.drawImage(Img.ground1,384,288,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 23) ctx.drawImage(Img.ground1,384,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 24) ctx.drawImage(Img.ground1,480,192,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10025) ctx.drawImage(Img.water1,32,288,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 26) ctx.drawImage(Img.ground1,480,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10027) ctx.drawImage(Img.ground1,448,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10028) ctx.drawImage(Img.water1,32,352,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10029) ctx.drawImage(Img.ground1,384,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10030) ctx.drawImage(Img.ground1,448,320,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 10031) ctx.drawImage(Img.ground1,384,320,32,32,tileX,tileY,tileSize,tileSize);
