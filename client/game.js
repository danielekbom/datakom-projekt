...
function drawMap(){
    ...
    for(y = Math.floor(player.y / tileSize - 11); y < Math.floor(player.y / tileSize + 11); y++){
        ...
        for(x = Math.floor(player.x / tileSize - 16); x < Math.floor(player.x / tileSize + 16); x++){
            ...
            if(map[y][x] == 17) ctx.drawImage(Img.water1,32,320,32,32,tileX,tileY,tileSize,tileSize);
            ...
            if(map[y][x] == 21) ctx.drawImage(Img.water1,32,256,32,32,tileX,tileY,tileSize,tileSize);
            ...
            if(map[y][x] == 25) ctx.drawImage(Img.water1,32,288,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 26) ctx.drawImage(Img.ground1,480,160,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 27) ctx.drawImage(Img.ground1,448,256,32,32,tileX,tileY,tileSize,tileSize);
            if(map[y][x] == 28) ctx.drawImage(Img.water1,32,352,32,32,tileX,tileY,tileSize,tileSize);
